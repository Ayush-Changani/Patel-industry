...
namespace Backend.DAL
{
    public class CreateCommand
    {
        ...
        // ✅ Execute multiple SELECT result sets
        public static DataSet ExecuteDataset(SqlCommand cmd)
        {
            ...
            {
                throw new Exception("Error while executing ExecuteDataset: " + ex.Message);
            }
        }
    }
}
